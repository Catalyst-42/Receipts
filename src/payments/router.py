...
from src.payments.schemes import PaymentId, Payment, PaymentList, PaymentsStats
...
async def get_payments_stats(
    ...
    """Returns statistics for payment records."""
    return await payments_service.get_stats()
